...
%
\setbeamercolor{palette primary}{bg=mrggreen2,fg=mrgbeige}
\setbeamercolor{palette secondary}{fg=mrggreen2,bg=mrgbeige}
\setbeamercolor{palette tertiary}{fg=mrgbeige,bg=mrggreen2}
\setbeamercolor{palette quaternary}{fg=black,bg=white}

\setbeamercolor*{structure}{fg=mrggreen2}
\setbeamercolor{titlelike}{fg=black,bg=black!2!mrgbeige}

\setbeamercolor{block title}{use=structure,fg=mrgbeige,bg=mrggreen}
\setbeamercolor{block body}{use=structure,fg=mrggreen,bg=mrgbeige}
...
\setbeamertemplate{footline}
{
  ...
  \end{beamercolorbox}%
  \begin{beamercolorbox}[wd=.39999\paperwidth,ht=2.25ex,dp=1ex,center]{title in head/foot}%
...
\title{QSP Models in Translation} 
...
%\vskip 1cm
%\centerline{\LARGE{\textcolor{mrggreen}{ #1}}}
}
